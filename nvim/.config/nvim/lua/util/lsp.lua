...
M.on_attach = function(client, bufnr)
  ...
  if client.name == "clangd" then
    ...
    -- clangd switch
    mapkey("<leader>sh", "ClangdSwitchSourceHeader", "n", opts) -- C/Cpp Switch Header
    mapkey("<leader>th", "ClangdToggleInlayHints", "n", opts)   -- C/Cpp Switch Header
    mapkey("<leader>as", "ClangdAST", "n", opts)                -- C/Cpp Switch Header
    mapkey("<leader>si", "ClangdSymbolInfo", "n", opts)         -- C/Cpp Switch Header
